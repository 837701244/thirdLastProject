...
const model = mongoose.model("categoryModel",categorySchema,"category");
...
class CategoryModel{
    ...
    async catrgory(){
        return   await model.find({parentId:{$gte:1}});
    }
    async catrgoryBig(){
      return   await model.find();
    }
...
// categoryModel.catrgory().then(i=>{
//     // console.log(i)
// })
// categoryModel.catrgoryBig().then(i=>{
//     console.log(i)
// })
